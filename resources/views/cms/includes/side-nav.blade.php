<nav class="navbar-default navbar-static-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav metismenu" id="side-menu">
            ...
            @can('edit_content')
            <li class="{{ (strpos($currentRouteName, 'product-images') !== false) ? 'active' : '' }}">
                <a href="{{ route('cms.product-images.index') }}"><i class="fa fa-picture-o"></i> <span class="nav-label">Ürün Görselleri </span></a>
            </li>
            @endcan
            ...
            @can('edit_content')
                <li class="{{ (strpos($currentRouteName, 'sliders') !== false) ? 'active' : '' }}">
                    <a href="{{ route('cms.sliders.index') }}"><i class="fa fa-image"></i> <span class="nav-label">Sliderlar </span></a>
                </li>
            @endcan
